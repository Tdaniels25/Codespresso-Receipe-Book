      ...
      <div className="content-container">
        ...
        <div className="receipeContainer">
          <div className="box">
            ...
            <p>
              A soothing coffee blend that helps you relax while sipping through
              complex syntax and coding structures
            </p>
            <Link to="/RecipeB">
              <p className="btn">View Recipe</p>
            </Link>
        ...
        <div className="receipeContainer">
          <div className="box">
            ...
            <p>
              A perfectly proportioned latte, ideal for those quick coding
        ...
        <div className="receipeContainer">
          <div className="box">
            ...
            <p>
              A delightful espresso shot that overflows with flavor, just like
              your code overflows with innovation
            </p>
            <Link to="/RecipeD">
              <p className="btn">View Recipe</p>
            </Link>
